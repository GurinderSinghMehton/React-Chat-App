...
function Auth() {
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex items-center justify-center">
      <div className="h-[95vh] bg-white border-2 border-white text-opacity-90 shadow-2xl w-[95vw] md:w-[90vw] md:h-[85vh] lg:w-[70vw] lg:h-[85vh] xl:w-[60-vw] xl:h-[80vh] rounded-3xl grid xl:grid-cols-2">
          ...
          <div className="flex items-center justify-center w-full">
            <Tabs defaultValue="login" className="w-3/4">
              ...
              <TabsContent className="flex flex-col gap-5 mt-10" value="login">
                ...
                <Link
                  className="text-right text-sm text-blue-800"
